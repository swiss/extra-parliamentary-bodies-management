...
{
    public const string Male = "https://register.ld.admin.ch/i14y/concept/DV_SEXE/1";
    public const string Female = "https://register.ld.admin.ch/i14y/concept/DV_SEXE/2";
