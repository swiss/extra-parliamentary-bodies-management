...
[TestFixture]
internal class CommitteeUpdateValidatorTests
{
    private CommitteeUpdateValidator _validator;

    [SetUp]
    public void SetUp()
    {
        _validator = new CommitteeUpdateValidator();
    }
    ...
    private static CommitteeUpdateDto BuildValidModel()
    {
        return new CommitteeUpdateDto
        {
            Id = Guid.NewGuid(),
            CommitteeNumber = 1337,
            IsActive = true,
