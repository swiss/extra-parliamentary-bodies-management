...
[TestFixture]
internal class ContactPointUpdateValidatorTests
{
    private ContactPointUpdateValidator _validator;

    [SetUp]
    public void SetUp()
    {
        _validator = new ContactPointUpdateValidator();
    }
    ...
    private static ContactPointUpdateDto BuildValidModel()
    {
