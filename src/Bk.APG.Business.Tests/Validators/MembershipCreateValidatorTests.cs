...
[TestFixture]
internal class MembershipCreateValidatorTests
{
    private MembershipCreateValidator _validator;

    [SetUp]
    public void SetUp()
    {
        _validator = new MembershipCreateValidator();
    }
    ...
    {
        var model = new MembershipCreateDto
        {
    ...
    private static MembershipCreateDto BuildValidModel()
    {
