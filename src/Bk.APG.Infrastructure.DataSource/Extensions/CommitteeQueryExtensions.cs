...
public static class CommitteeQueryExtensions
{
    ...
    public static IQueryable<GeneralElectionCommittee> SortCommittees(this IQueryable<GeneralElectionCommittee> committees, string sort, SortDirection sortDirection, CultureInfo cultureInfo)
    {
        return sort.ToLowerInvariant() switch
        {
            "description" => committees.SortByProperty(c => c.DescriptionGerman, c => c.DescriptionFrench, c => c.DescriptionItalian, sortDirection, cultureInfo),
