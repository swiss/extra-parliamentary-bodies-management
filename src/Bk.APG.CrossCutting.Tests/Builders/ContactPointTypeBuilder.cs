...
public class ContactPointTypeBuilder
{
    ...
    public ContactPointTypeBuilder()
    {
    ...
    public ContactPointTypeBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public ContactPointTypeBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public ContactPointType Build()
    {
