...
public class DepartmentBuilder
{
    ...
    public DepartmentBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public DepartmentBuilder WithGermanText(string text)
    {
        _textDe = text;
        return this;
    }

    public DepartmentBuilder WithGermanDescription(string description)
    {
        _descriptionDe = description;
        return this;
    }

    public DepartmentBuilder WithIsBigDepartment(bool isBigDepartment)
    {
        _isBigDepartment = isBigDepartment;
        return this;
    }
