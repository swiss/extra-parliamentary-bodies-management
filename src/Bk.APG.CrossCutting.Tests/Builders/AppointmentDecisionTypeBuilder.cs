...
public class AppointmentDecisionTypeBuilder
{
    ...
    public AppointmentDecisionTypeBuilder()
    {
    ...
    public AppointmentDecisionTypeBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public AppointmentDecisionTypeBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public AppointmentDecisionType Build()
    {
        return new AppointmentDecisionType
        {
            Id = _id,
            Created = _created,
