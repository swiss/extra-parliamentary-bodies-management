...
public class TermOfOfficeBuilder
{
    ...
    public TermOfOfficeBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public TermOfOfficeBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public TermOfOfficeBuilder WithGermanText(string text)
    {
        _textDe = text;
        return this;
    }

    public TermOfOfficeBuilder WithGermanDescription(string description)
    {
        _descriptionDe = description;
        return this;
    }

    public TermOfOffice Build()
    {
