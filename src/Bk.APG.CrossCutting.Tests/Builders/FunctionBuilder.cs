...
public class FunctionBuilder
{
    ...
    private string _textFemaleDe = "_textFemaleDe";
    private readonly string _textFemaleFr = "_textFemaleFr";
    private readonly string _textFemaleIt = "_textFemaleIt";
    private readonly string _textFemaleRm = "_textFemaleRm";
    ...
    public FunctionBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public FunctionBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public FunctionBuilder WithGermanText(string text)
    {
        _textDe = text;
        return this;
    }

    public FunctionBuilder WithGermanFemaleText(string text)
    {
        _textFemaleDe = text;
        return this;
    }

    public FunctionBuilder WithGermanDescription(string description)
    {
