...
public class LegalFormBuilder
{
    ...
    private string _legalFormId;

    public LegalFormBuilder()
    {
        ...
        _legalFormId = _faker.Random.String();
    }

    public LegalFormBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public LegalFormBuilder WithLegalFormId(string legalForm)
    {
        _legalFormId = legalForm;
        return this;
    }

    public LegalFormBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public LegalForm Build()
    {
