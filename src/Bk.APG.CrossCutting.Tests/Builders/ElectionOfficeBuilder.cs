...
public class ElectionOfficeBuilder
{
    ...
    public ElectionOfficeBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public ElectionOfficeBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public ElectionOfficeBuilder WithGermanText(string text)
    {
        _textDe = text;
        return this;
    }

    public ElectionOfficeBuilder WithGermanDescription(string description)
    {
        _descriptionDe = description;
        return this;
    }

    public ElectionOffice Build()
    {
        return new ElectionOffice
        {
            Id = _id,
            Created = _created,
