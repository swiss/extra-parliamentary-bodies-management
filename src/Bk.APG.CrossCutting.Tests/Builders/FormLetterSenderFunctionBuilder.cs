...
public class FormLetterSenderFunctionBuilder
{
    ...
    public FormLetterSenderFunctionBuilder()
    {
    ...
    public FormLetterSenderFunction Build()
    {
        return new FormLetterSenderFunction
        {
            Id = _id,
            Created = _created,
