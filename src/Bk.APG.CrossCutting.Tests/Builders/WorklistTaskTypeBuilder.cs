...
public class WorklistTaskTypeBuilder
{
    ...
    private bool _canBeCreatedManually;

    public WorklistTaskTypeBuilder()
    {
        ...
        _canBeCreatedManually = true;
    }

    public WorklistTaskTypeBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public WorklistTaskTypeBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public WorklistTaskTypeBuilder WithGermanText(string text)
    {
        _textDe = text;
        return this;
    }

    public WorklistTaskTypeBuilder WithGermanDescription(string description)
    {
        _descriptionDe = description;
        return this;
    }

    public WorklistTaskTypeBuilder WithCanBeCreatedManually(bool canBeCreatedManually)
    {
        _canBeCreatedManually = canBeCreatedManually;
        return this;
    }

    public WorklistTaskType Build()
    {
        return new WorklistTaskType
        {
            Id = _id,
            Created = _created,
            ...
            Sort = _sort,
            OldId = _oldId,
            CanBeCreatedManually = _canBeCreatedManually
        };
    }
}
