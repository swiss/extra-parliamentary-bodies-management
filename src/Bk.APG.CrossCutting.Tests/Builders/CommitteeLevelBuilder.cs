...
public class CommitteeLevelBuilder
{
    ...
    public CommitteeLevelBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public CommitteeLevelBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public CommitteeLevelBuilder WithGermanText(string text)
    {
        _textDe = text;
        return this;
    }

    public CommitteeLevelBuilder WithGermanDescription(string description)
    {
        _descriptionDe = description;
        return this;
    }

    public CommitteeLevel Build()
    {
        return new CommitteeLevel
        {
            Id = _id,
            Created = _created,
