...
public class SalutationBuilder
{
    ...
    public SalutationBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public SalutationBuilder WithGender(Guid id)
    {
        _genderId = id;
        return this;
    }

    public SalutationBuilder WithDescriptionDe(string description)
    {
