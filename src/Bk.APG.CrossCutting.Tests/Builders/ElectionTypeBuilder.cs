...
public class ElectionTypeBuilder
{
    ...
    public ElectionTypeBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public ElectionTypeBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public ElectionTypeBuilder WithGermanText(string text)
    {
        _textDe = text;
        return this;
    }

    public ElectionTypeBuilder WithGermanDescription(string description)
    {
        _descriptionDe = description;
        return this;
    }

    public ElectionType Build()
    {
