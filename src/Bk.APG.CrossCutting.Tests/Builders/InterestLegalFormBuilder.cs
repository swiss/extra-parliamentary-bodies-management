...
public class InterestLegalFormBuilder
{
    ...
    public InterestLegalFormBuilder()
    {
    ...
    public InterestLegalFormBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public InterestLegalFormBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public InterestLegalForm Build()
    {
        return new InterestLegalForm
        {
            Id = _id,
            Created = _created,
