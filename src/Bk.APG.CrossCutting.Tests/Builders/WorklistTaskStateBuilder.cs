...
public class WorklistTaskStateBuilder
{
    ...
    public WorklistTaskStateBuilder()
    {
    ...
    public WorklistTaskStateBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public WorklistTaskStateBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public WorklistTaskStateBuilder WithGermanText(string text)
    {
        _textDe = text;
        return this;
    }

    public WorklistTaskStateBuilder WithGermanDescription(string description)
    {
        _descriptionDe = description;
        return this;
    }

    public WorklistTaskState Build()
    {
        return new WorklistTaskState
        {
            Id = _id,
            Created = _created,
