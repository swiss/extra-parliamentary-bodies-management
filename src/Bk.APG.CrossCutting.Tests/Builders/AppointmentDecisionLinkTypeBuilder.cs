...
public class AppointmentDecisionLinkTypeBuilder
{
    ...
    public AppointmentDecisionLinkTypeBuilder()
    {
    ...
    public AppointmentDecisionLinkTypeBuilder WithId(Guid id)
    {
        _id = id;
        return this;
    }

    public AppointmentDecisionLinkTypeBuilder WithUri(string uri)
    {
        _uri = uri;
        return this;
    }

    public AppointmentDecisionLinkType Build()
    {
        return new AppointmentDecisionLinkType
        {
            Id = _id,
            Created = _created,
